...
public class AddProductVM implements Initializable {
    @FXML
    ...
    public AddProductVM(TableView<ShopProduct> productTableView, ObservableList<ShopProduct> productItems,
    ...
    public AddProductVM(ShopProduct product, TableView<ShopProduct> productTableView, ObservableList<ShopProduct> productItems,
                        TableColumn<ShopProduct, String> nameColumn, TableColumn<ShopProduct, String> brandColumn,
                        TableColumn<ShopProduct, Boolean> availabilityColumn, TableColumn<ShopProduct, Number> priceColumn,
                        int idShop) {
        isEditing = true;
